import { EventCardSection } from "@/components/ad-coo-dashboard/sections/coordinatorEvent-card";
...
const Coordinator = async () => {
   ...
   if(role!=="coordinator") redirect("/unauthorized")


  return (
    <section className="min-h-screen relative mt-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto py-8 sm:py-12 relative z-10">
        ...
        <div>
          ...
          <Suspense fallback={<EventCardSkeleton/>}>
              <EventCardSection coordinatorId={user?.sub}/>
          </Suspense>
        </div>
      </div>
    </section>
